...
public class OpenWeatherService {
    ...
    private String openWeather5DayApiUrl = "https://api.openweathermap.org/data/2.5/forecast";

    @Value("${open.weather.air.api.url}")
    private String openWeatherAirApiUrl = "http://api.openweathermap.org/data/2.5/air_pollution";
...
//        urlBuilder.append("?" + URLEncoder.encode("q", "UTF-8") + "=Seoul");
    ...
    // 미세먼지 농도를 가져오는 서비스
    public OpenWeatherAirDTO getCurrentAirData() throws UnsupportedEncodingException {

        String lat ="37.22296455822422";
        String lon ="127.05652887872013";
